...
grader.start_assignment("Brian", itp_id)
print("Brian's Lesson:", grader.get_lesson("Brian"))
print(
    "Brian's check:",
    grader.check_assignment("Brian", "a = 1\nb = 'hello'"),
)
print(
    "Brian's other check:",
    grader.check_assignment("Brian", "a = 1\nb = 'hello'"),
...
print(grader.assignment_summary("Brian"))

grader.start_assignment("Brian", stat_id)
print("Brian's Lesson:", grader.get_lesson("Brian"))
print("Brian's check:", grader.check_assignment("Brian", "avg=5.25"))
print(
    "Brian's other check:",
    grader.check_assignment(
        "Brian", "avg = statistics.mean([1, 5, 18, -3])"
    ),
)
