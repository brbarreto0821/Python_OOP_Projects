# Creating a machine learning program that learns about RGB color definition
import random
...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.create_widgets()
        self.file = csv.writer(open("colors.csv", "a", newline=''), delimiter=' ', quotechar=',', quoting=csv.QUOTE_MINIMAL)
    ...
    def create_widgets(self):
        ...
        self.quit.grid(column=0, row=5, columnspan=2, sticky="new")
